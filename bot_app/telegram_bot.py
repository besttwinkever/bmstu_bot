...
from bauman_event_tg_bot.settings import APP_TZ, TELEGRAM_BOT_TOKEN, API_URL, BACKEND_URL
...
#         aware_dt = APP_TZ.localize(naive_dt)
...
#                         f"Преподаватель:{event.teacher.user.last_name} {event.teacher.user.first_name} {event.teacher.user.middle_name}\n"
#                     )
...
#                         f"Название: {event.title}\n"
#                         f"Описание: {event.description}\n"
#                         f"Дата: {event.date.astimezone(APP_TZ).strftime('%Y-%m-%d %H:%M')}\n"
#                         f"Повторение: {recurrence_info}\n"
#                         f"Преподаватель: {event.teacher.user.last_name} {event.teacher.user.first_name} {event.teacher.user.middle_name}\n\n"
#                     )
#             else:
...
#                 f"📥 Новый файл от {student.user.last_name} {student.user.first_name} {student.user.middle_name}:\nОписание: {data['description']}"
#             )
...
#         local_dt = sub.created_at.astimezone(APP_TZ)
#         text = (
#             f"👤 Студент: {sub.student.user.last_name} {sub.student.user.first_name} {sub.student.user.middle_name}\n"
